...
| :------------------ | ---------- | -------------- | ------------ | :---------------- | --------------------- | ------------------- | ------------------------------------------------------------------------------- |
| Can be instantiated | No         | Unknown status | No           | Forbidden         | Forbidden             | none                | [greaterEqual.json](operators/numeric/greaterEqual.json "open original schema") |

## >= Type

`object` ([>=](greaterequal.md))
