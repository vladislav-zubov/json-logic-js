...
```txt
http://jsonlogic.com/schemas/operators/arithmetic/substract.json
```
...
| :------------------ | ---------- | -------------- | ------------ | :---------------- | --------------------- | ------------------- | ---------------------------------------------------------------------------- |
| Can be instantiated | No         | Unknown status | No           | Forbidden         | Forbidden             | none                | [substract.json](operators/arithmetic/substract.json "open original schema") |
