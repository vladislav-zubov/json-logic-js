...
```txt
https://raw.githubusercontent.com/vladislav-zubov/json-logic-js/master/schemas/common/one-or-more-args.json
```
...
merged type ([1 or more args](one-or-more-args.md))
